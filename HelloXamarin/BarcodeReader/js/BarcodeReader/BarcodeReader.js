...
var HoneywellBarcodeReaderUtils = {
    ...
    { name: "Code93", honeywellId: "i", aimId: "G0" }, { name: "Code128", honeywellId: "j", aimId: "C0" }, { name: "GS1_128", honeywellId: "I", aimId: "C1" }, { name: "ISBT128", honeywellId: "j", aimId: "C4" }, { name: "DATAMATRIX", honeywellId: "w", aimId: "d1" }, { name: "DOTCODE", honeywellId: ".", aimId: "J0" }, { name: "DIGIMARC", honeywellId: "|", aimId: "X0" }, { name: "EAN8", honeywellId: "D", aimId: "E4" }, { name: "EAN13", honeywellId: "d", aimId: "E0" }, { name: "CHINAPOST", honeywellId: "Q", aimId: "X0" }, { name: "DUTCHPOST", honeywellId: "K", aimId: "X0" }, {
        name: "GridMatrix",
        honeywellId: "X", aimId: "g0"
    }, { name: "GS1EX", honeywellId: "}", aimId: "e0" }, { name: "GS1LI", honeywellId: "{", aimId: "e0" }, { name: "GS1OD", honeywellId: "y", aimId: "e0" }, { name: "HANXIN", honeywellId: "H", aimId: "X0" }, { name: "INFOMAIL", honeywellId: ",", aimId: "X0" }, { name: "INTELLIGENTMAIL", honeywellId: "M", aimId: "X0" }, { name: "ITF", honeywellId: "e", aimId: "I0" }, { name: "ITFMatrix", honeywellId: "m", aimId: "X0" }, { name: "ITFStandard", honeywellId: "f", aimId: "S0" }, { name: "JAPANPOST", honeywellId: "J", aimId: "X0" }, {
        name: "KOREANPOST", honeywellId: "?",
        aimId: "X0"
    }, { name: "MAXICODE", honeywellId: "x", aimId: "U0" }, { name: "MICROPDF", honeywellId: "R", aimId: "L0" }, { name: "MSI", honeywellId: "g", aimId: "M0" }, { name: "PDF417", honeywellId: "r", aimId: "L0" }, { name: "PLANET", honeywellId: "L", aimId: "X0" }, { name: "POSTNET", honeywellId: "P", aimId: "X0" }, { name: "QR", honeywellId: "s", aimId: "Q1" }, { name: "SWEDENPOST", honeywellId: "[", aimId: "X0" }, { name: "TELEPEN", honeywellId: "t", aimId: "B1" }, { name: "TLC39", honeywellId: "T", aimId: "L2" }, { name: "TRIOPTIC", honeywellId: "\x3d", aimId: "X0" }, {
        name: "UPCA",
        honeywellId: "c", aimId: "E0"
    }, { name: "UPCCoupon", honeywellId: ";", aimId: "E0" }, { name: "UPCE", honeywellId: "E", aimId: "E0" }], HoneywellBarcodeReaderWebEventDispatcher = {
        defaultScannerName: "dcs.scanner.imager", create: function (a) {
            function d(b, g) { if (typeof HoneywellBarcodeReaderUtils.log === typeof Function) { var a = b ? b + " " : ""; "object" === typeof g ? HoneywellBarcodeReaderUtils.log(a + JSON.stringify(g)) : HoneywellBarcodeReaderUtils.log(a + g) } } var e = "http://127.0.0.1:8080/jsonrpc/" + a + "/events", g = !1, c = null, h = null, b = 1, l = function () { },
                n = function () { }, m, f, k, p = function () { f || ("undefined" !== typeof document.webkitHidden ? (f = "webkitHidden", k = "webkitvisibilitychange") : "undefined" !== typeof document.hidden && (f = "hidden", k = "visibilitychange")); f && "undefined" !== typeof document.addEventListener && !m && (m = function () { document[f] || (g = !0, q(), d("handleDocVisibilityChangeEvent", "requestEvents")) }, document.addEventListener(k, m, !1)) }, r = function (b) { b != g && (g = b) && q(); b ? p() : m && (document.removeEventListener(k, m), m = null) }, q = function () {
                    var a = new XMLHttpRequest;
                    a.open("POST", e, !0); a.setRequestHeader("Content-Type", "application/json"); a.onreadystatechange = function () {
                        var b; if (4 == a.readyState) if (200 == a.status) try {
                            if (b = JSON.parse(a.responseText), HoneywellBarcodeReaderUtils.hasProperty(b, "result", !0)) { var e = b.result.session; e && (c = e); if (HoneywellBarcodeReaderUtils.hasProperty(b.result, "events", !0)) { 0 < b.result.events.length && d("Barcode event response:", b); var f, k; for (f = 0; f < b.result.events.length; f++)k = b.result.events[f], l(k.method, k.params, h) } g && q() } else b.error &&
                                (n(b.error.code, b.error.message), d("events.getNext error response:", "code: " + b.error.code + " message: " + b.error.message))
                        } catch (m) { d("Failed to handle response", a.responseText), n(-1, m.message), g = !1 } else d("HTTP error", "status " + a.status + " " + a.statusText), n(a.status, a.statusText), g = !1
                    ...
                    eventTimeout: 60,
                    startSession: function (b) { l = HoneywellBarcodeReaderUtils.hasProperty(b, "event", !0) ? b.event : function () { }; n = HoneywellBarcodeReaderUtils.hasProperty(b, "error", !0) ? b.error : function () { }; h = HoneywellBarcodeReaderUtils.hasProperty(b, "filter", !0) ? b.filter : null; r(!0); d(null, "Event session started") }, stopSession: function () { r(!1); d(null, "Event session stopped") }
                }; return s
        }
    };
(function (a) {
    var d = 0; HoneywellBarcodeReaderUtils.setup(); var e = function (a) { HoneywellBarcodeReaderUtils.barcodeReaderObjName ? setTimeout(function () { a() }, 0) : 6E4 > d ? (d += 100, setTimeout(function () { e(a) }, 100)) : setTimeout(function () { a() }, 0) }; a.BarcodeReader = function (a, c) {
